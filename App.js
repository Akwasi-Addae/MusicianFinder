...
function ChurchTabs() {
  return (
    <Tab.Navigator>
      <Tab.Screen name="ChurchHomeScreen" component={ChurchHomeScreen} options={{headerShown: false}}/>
      <Tab.Screen name="CreateGigScreen" component={CreateGigScreen} options={{headerShown: false}}/>
    </Tab.Navigator>
  );
}
